...
public class Doctor {
    ...
    public Doctor(String did, String dname, String dtype, String dindate, String dintime, String ddob, String dtelephone, String dqualification, double dfee, String demail) {
        this.did = did;
        this.dname = dname;
        this.dtype = dtype;
